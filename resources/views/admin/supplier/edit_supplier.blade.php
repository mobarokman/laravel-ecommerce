    ...
    <!-- Modal -->
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{route('admin.supplier.update', $supplier->supplier_id)}}" method="post" id="editSupplierForm">
                            @csrf
                            @method('PUT') 
                           <div class="row">
                                <div class="form-group col-md-6">
                                        <label for="inputText3" class="col-form-label">Company/Supplier Name <span class="text-danger">*</span> </label>
                                <input name="company_name" id="inputText3" type="text" class="form-control" placeholder="Enter tag name" value="{{$supplier->company_name}}">
                                        <span id="error-company_name" class="invalid-feedback"></span>
                                    </div>

                                <div class="form-group col-md-6">
                                        <label for="inputText3" class="col-form-label">Contact Name</label>
                                        <input name="contact_name" id="inputText3" type="text" class="form-control" placeholder="Enter tag name" value="{{$supplier->contact_name}}">
                           ...
                           <div class="row">
                                <div class="form-group col-md-4">
                                        ...
                                        <input name="email" id="inputText3" type="text" class="form-control" placeholder="Enter tag name" value="{{$supplier->email}}">
                                ...
                                <div class="form-group col-md-4">
                                        ...
                                        <input name="phone" id="inputText3" type="text" class="form-control" placeholder="Enter tag name" value="{{$supplier->phone}}">
                                        <span id="error-phone" class="invalid-feedback"></span>
                                    </div>
                                <div class="form-group col-md-4">
                                        <label for="inputText3" class="col-form-label">Fax</label>
                                        <input name="fax" id="inputText3" type="text" class="form-control" placeholder="Enter tag name" value="{{$supplier->fax}}">
                           ...
                           <div class="row">
                                <div class="form-group col-md-4">
                                        ...
                                        <textarea name="address" class="form-control" id="exampleFormControlTextarea1 description" rows="3" placeholder="Write Short Description"> {{$supplier->address}} </textarea>
                                        <span id="error-address" class="invalid-feedback"></span>
                                    </div>

                                <div class="form-group col-md-8">
                                        <label for="exampleFormControlTextarea2">Short Description</label>
                                        <textarea name="description" class="form-control" id="exampleFormControlTextarea2 description" rows="3" placeholder="Write Short Description"> {{$supplier->address}} </textarea>
