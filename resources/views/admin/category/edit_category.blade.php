    ...
    <div class="modal-body">
        <form action="{{route('admin.category.update', $category->category_id)}}" method="post" id="editCategoryForm">
            ...
            <div class="form-group">
                    ...
                    <input name="category_name" id="inputText3 cat_name" type="text" class="form-control" placeholder="Enter category name" value="{{ $category->category_name }}">
            ...
            <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" id="exampleFormControlTextarea1 description" rows="3" placeholder="Write Short Description"> {{ $category->description }} </textarea>
                    <span id="error-description" class="invalid-feedback"></span>
                </div>

                <label class="custom-control custom-checkbox">
                    <input name="status" type="checkbox" class="custom-control-input"><span class="custom-control-label">Active Status</span>
                </label>
