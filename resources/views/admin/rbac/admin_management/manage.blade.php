            ...
            <div class="card border-white shadow-sm">
                <div class="card-header border-0 bg-white">
                    <span class="border-bottom-0">
                        <h4 style="display: inline;" class="card-title">Admin List</h4>
                        <a style="float:right;" class="btn btn-info" id="add-role-btn" href="#">Create new Admin</a>
...
<script>
    $(document).ready(function () {
        ...
        //reLoad fun.
        function reLoad() {
            $.get("{{ route('admin.adminList')}}", function (data) {
                $("#admin-list").empty().append(data);
            });
        }
        ...
        // $('#get-modal-request').on('submit', '#add-role-form', function (e) {
        //     e.preventDefault();
